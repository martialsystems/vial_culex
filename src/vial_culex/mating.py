...
"""k-NN on thief-path traits after starve. Delayed cap. Random fallback."""
...
from vial_culex.diet import fruit_available
from vial_culex.fitness import Phenotype
from vial_culex.genome import FEMALE, MALE, S_POST_STARVE, S_PRE_STARVE, Pop
